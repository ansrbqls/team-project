...
function CouponsPage() {
    _s();
    const { coupons } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$useStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])();
    ...
    const getTodayCoupons = ()=>{
        ...
        return coupons.filter((coupon)=>new Date(coupon.createdAt).toDateString() === today.toDateString());
    };
    ...
    const getThisWeekCoupons = ()=>{
        ...
        return coupons.filter((coupon)=>new Date(coupon.createdAt) >= startOfWeek);
    };
...
_s(CouponsPage, "BMBfb1ehgHTBVn67CWX4Cg1BQJo=", false, function() {
    return [
...
//# sourceMappingURL=src_app_admin_coupons_page_tsx_408d8996._.js.map